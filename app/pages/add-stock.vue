...
const searchInputRef = ref<UInputRef | null>(null)
  ...
  <div class="container mx-auto p-6 max-w-3xl">
    <div class="mb-8">
      ...
      <p class="text-gray-600 dark:text-gray-400">
        Search for a part and add stock
      </p>
    </div>
    ...
    <UCard class="mb-6">
      ...
      <div class="space-y-4">
        <UFormField
          label="Search by Name or IPN"
          description="Enter part name or internal part number"
        >
        ...
        <div
          v-if="selectedPart"
          class="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800 mt-4"
        >
          <div class="flex items-start justify-between">
            <div>
              ...
              <p
                v-if="selectedPart.IPN"
                class="text-sm text-gray-600 dark:text-gray-400"
              >
                IPN: {{ selectedPart.IPN }}
              </p>
              <p
                v-if="selectedPart.description"
                class="text-sm mt-1"
              >
                {{ selectedPart.description }}
              </p>
              <p class="text-sm mt-2 font-medium">
                Current Stock: {{ selectedPart.in_stock || 0 }} units
              </p>
            </div>
    ...
    <UCard>
      ...
      <div class="bg-gray-50 dark:bg-gray-900 rounded p-4 font-mono text-xs max-h-96 overflow-y-auto">
        ...
        <div
          ...
          :key="index"
          class="mb-2 whitespace-pre-wrap break-all"
        >
          {{ log }}
        </div>
      </div>
